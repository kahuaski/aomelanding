                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10 lg:gap-8">
                    ...
                    <div>
                        ...
                        <ul className="space-y-3">
                            <li><a href="#inicio" className="text-white hover:text-amber-400 transition-colors duration-200">{t.nav.home}</a></li>
                            <li><a href="#about" className="text-white hover:text-amber-400 transition-colors duration-200">{t.nav.about}</a></li>
                            <li><a href="#servicios" className="text-white hover:text-amber-400 transition-colors duration-200">{t.nav.services}</a></li>
                            <li><a href="#contacto" className="text-white hover:text-amber-400 transition-colors duration-200">{t.nav.contact}</a></li>
                        </ul>
                    </div>
                    ...
                    <div>
                        ...
                        <div className="flex flex-wrap gap-3">
                            {/* Facebook */}
                            <a href="https://facebook.com/" target="_blank" rel="noopener noreferrer" aria-label="Aome Electric on Facebook" className="w-10 h-10 bg-gray-800 hover:bg-blue-600 rounded-full flex items-center justify-center transition-colors duration-300">
                                <svg className="w-5 h-5 fill-white" viewBox="0 0 24 24"><path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z"/></svg>
                            </a>
                            {/* Instagram */}
                            <a href="https://instagram.com/" target="_blank" rel="noopener noreferrer" aria-label="Aome Electric on Instagram" className="w-10 h-10 bg-gray-800 hover:bg-gradient-to-br hover:from-purple-600 hover:to-pink-500 rounded-full flex items-center justify-center transition-all duration-300">
                            ...
                            {/* TikTok */}
                            <a href="https://tiktok.com/" target="_blank" rel="noopener noreferrer" aria-label="Aome Electric on TikTok" className="w-10 h-10 bg-gray-800 hover:bg-black rounded-full flex items-center justify-center transition-colors duration-300 border border-transparent hover:border-white">
                            ...
                            {/* YouTube */}
                            <a href="https://youtube.com/" target="_blank" rel="noopener noreferrer" aria-label="Aome Electric on YouTube" className="w-10 h-10 bg-gray-800 hover:bg-red-600 rounded-full flex items-center justify-center transition-colors duration-300">
